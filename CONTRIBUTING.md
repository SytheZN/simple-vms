...
2. Make your changes, adding or updating tests for any changed behavior.
3. Run the full test suite and confirm it passes (`./build.sh test`).
...
Review the [architecture](docs/architecture.md) and [plugin](docs/plugins.md) docs before making structural changes.
