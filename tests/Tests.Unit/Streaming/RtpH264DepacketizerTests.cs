...
public class RtpH264DepacketizerTests
{
  ...
  public void StapA_SplitsIntoMultipleNalUnits()
  {
    ...
    var results = _depacketizer.ProcessStapAAll(payload, 2000, 2000);
  ...
  public void FuA_ReassemblesFromStartMiddleEnd()
  {
    ...
    var r1 = _depacketizer.ProcessPacket(start, 3000, 3000);
    Assert.That(r1, Is.Null);

    // FU header middle: S=0, E=0, type=5 -> 0x05
    byte[] middle = [0x7C, 0x05, 0xCC, 0xDD];
    var r2 = _depacketizer.ProcessPacket(middle, 3000, 3000);
    Assert.That(r2, Is.Null);

    // FU header end: E=1, type=5 -> 0x45
    byte[] end = [0x7C, 0x45, 0xEE, 0xFF];
    var r3 = _depacketizer.ProcessPacket(end, 3000, 3000);
  ...
  {
    byte[] middle = [0x7C, 0x05, 0xCC, 0xDD];
    var result = _depacketizer.ProcessPacket(middle, 4000, 4000);
  ...
  {
    var result = _depacketizer.ProcessPacket(ReadOnlySpan<byte>.Empty, 0, 0);
    Assert.That(result, Is.Null);
  }
  ...
  public void SingleNal_UnknownType_ClassifiedAsOther()
  {
    ...
    var result = _depacketizer.ProcessPacket(payload, 7000, 7000);
  ...
  public void StapA_TruncatedPayload_ReturnsEmpty()
  {
    ...
    var results = _depacketizer.ProcessStapAAll(payload, 8000, 8000);
  ...
  public void UnsupportedNalType_ReturnsNull()
  {
    ...
    var result = _depacketizer.ProcessPacket(payload, 10000, 10000);
  ...
  public void SingleNal_Sps_NotSyncPoint()
  {
    ...
    var result = _depacketizer.ProcessPacket(payload, 11000, 11000);
  ...
  public void SingleNal_Pps_NotSyncPoint()
  {
    ...
    var result = _depacketizer.ProcessPacket(payload, 12000, 12000);
